...
const MobileNav = () => {
  ...
  return (
        <>
        <header className="flex flex-row flex-wrap justify-between bg-black px-1 h-24 content-center lg:hidden">
          ...
          <nav className="flex justify-center flex-col nowrap content-center items-center">
            ...
            <div className="overflow-hidden">
              <ul className={`fixed w-full h-auto bg-black flex nowrap flex-col top-11p z-50 left-0 justify-around content-center text-lg uppercase transition-all duration-500 px-4 py-2 ${open ? ' translate-x-0' : ' translate-x-full'}`}>
            <NavLinks />
              </ul>
            </div>
          </nav>
